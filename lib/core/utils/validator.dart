...
class Validator {
  ...
  static String? validateEmail({String? email, required BuildContext context}) {
    if ((email ??= "").trim().isEmpty) {
      ...
      return "pleaseEnterValidEmailAddress".tr;
    } else {
      return null;
    }
  }
  ...
  static String? validateName(
    ...
    if ((value ??= "").trim().isEmpty) {
      ...
      return 'pleaseEnterOnlyAlphabets'.tr;
    } else {
      return null;
    }
  }
  ...
  static String? nullCheckValidator(
    ...
    if (value!.isEmpty) {
      ...
      if (value.length < requiredLength) {
        return "${"textMustBe".tr} $requiredLength ${"characterLong".tr}";
      } else {
        return null;
      }
    }
  ...
  static String? validateSlug(String? slug, {required BuildContext context}) {
    ...
    if (!slugRegExp.hasMatch(slug)) {
      return "slugWarning".tr; // Customize the warning message
    }
